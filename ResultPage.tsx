...
import { FileJson, Home, Printer, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#fffaf0] p-4 md:p-10 flex flex-col items-center">
      <div className="max-w-5xl w-full space-y-6 animate-[fadeIn_0.5s_ease-out]">
        ...
        {/* Main Report Card */}
        <div className="bg-white rounded-[3rem] shadow-xl overflow-hidden border-[8px] border-white p-6 md:p-12 relative">
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="bg-orange-50 p-6 rounded-[2rem] space-y-4">
                ...
                <div className="h-60 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart cx="50%" cy="50%" outerRadius="80%" data={chartData}>
                      ...
                      <PolarAngleAxis dataKey="name" tick={{ fontSize: 11, fill: '#9a3412', fontWeight: 'bold' }} />
                      <PolarRadiusAxis angle={30} domain={[0, 10]} stroke="#fdba74" />
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl font-titr text-orange-950 leading-tight">گزارش روان‌شناختی</h2>
                <div className="flex flex-wrap items-center gap-3">
                  <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full font-yekan text-xs font-bold">تحلیل هوشمند Trace Mind</span>
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-xl font-nazanin text-orange-800 italic bg-gradient-to-l from-orange-50 to-white p-5 rounded-[1.5rem] border-r-8 border-orange-500 shadow-sm">
                    «{data.emotionalState}»
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="text-base font-nazanin text-gray-800 leading-relaxed text-justify space-y-4 bg-white p-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {data.recommendations.map((rec, i) => (
                      <div key={i} className="flex gap-3 bg-orange-50/30 border border-orange-100 p-4 rounded-[1.2rem] hover:bg-white transition-all shadow-sm group">
                        ...
                        <p className="font-yekan text-orange-950 text-sm leading-relaxed">{rec}</p>
                      </div>
                    ))}
                  </div>
                </section>
              ...
              <div className="pt-10 mt-10 border-t-2 border-orange-50 text-center">
                <p className="font-nazanin text-gray-400 italic text-sm max-w-xl mx-auto leading-relaxed">
